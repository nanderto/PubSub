...
namespace EsentTests
{
    class TestHelper
    {
                        ...
                        using (var instance = new Instance("createdatabasetest"))
                        {
                            ...
                            using (var session = new Session(instance))
                            {
                                ...
                                using (var transaction = new Transaction(session))
                                {
                                    ...
                                    JET_TABLEID tableid;
                                    Api.JetCreateTable(session, dbid, storeName + TableName, 16, 100, out tableid);
                                ...
                                {
                                    JET_TABLEID tableid;
                                    Api.JetCreateTable(session, dbid, storeName + "subscribermetadata", 16, 100, out tableid);
            ...
            do
            {
                ...
                try
                {
                    using (var instance = new Instance("MyInstanceName"))
                    {
                        ...
                        instance.Init();
                        var TableName = databaseName + "messages";
                        ...
                        using (var session = new Session(instance))
                        {
                            ...
                            TableName = databaseName + "subscribermetadata";
        ...
        public static void VerifyStore(string storeName)
        {
            using (var instance = new Instance("MyInstanceName"))
            {
                instance.Parameters.CircularLog = true;
                instance.Init();
                var TableName = storeName + "messages";
                ...
                using (var session = new Session(instance))
                {
                    ...
                    TableName = storeName + "subscribermetadata";
